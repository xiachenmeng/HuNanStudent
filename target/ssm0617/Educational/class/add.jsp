        ...
        $(function(){
            ...
            $("[name='deptid']").change(function(){
                ...
                if (val==-1){
                    ...
                    $.getJSON("/Educational/class/findmajorbyid","deptid="+val,function (rs) {
                        $("[name='majorid']")[0].length=0;
                        $("[name='majorid']")[0].add(new Option("--请选择专业--",-1));
            ...
            $("[name='majorid']").change(function(){
                ...
                if (val==-1){
                    ...
                    $.getJSON("/Educational/class/findclassbyid", "mid=" + val, function (rs) {
                        $("[name='classteacher']")[0].length = 0;

                        for (var i = 0; i < rs.length; i++) {
                            $("[name='classteacher']")[0].add(new Option(rs[i], rs[i]));
                        }
                    })
                }
            });
