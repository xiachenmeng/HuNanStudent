...
<html>
    ...
    <body>
        ...
        <table cellspacing=0 cellpadding=2 width="95%" align=center border=0>
            <tr>
                <td align=right width=100>手机号查询归属地：</td>
                <td style="color: #880000"><input type="text" id="phone"><span></span> </td></tr>
            <script>
                $(function(){
                    $("#phone").blur(function () {
                    var val=$(this).val();
            ...
            <tr>
                ...
                <td style="color: #880000"><fmt:formatDate value="${user.regdate}" pattern="yyyy-MM-dd"></fmt:formatDate> </td></tr>
            <tr>
