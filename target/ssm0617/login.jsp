					...
					<div class="user_main_box">
						<ul>
							...
							<li class="user_main_input">
								<input name="TxtUserName" maxlength="20" id="TxtUserName" class="txtusernamecssclass"> </li>
						</ul>
						<ul>
							<li class="user_main_text">密 码： </li>
							<li class="user_main_input">
								<input type="password" name="TxtPassword" id="TxtPassword" class="txtpasswordcssclass"> </li>
						</ul>
						<ul>
